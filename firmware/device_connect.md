...
![alt text](img/device_connect/image.png)
...
![alt text](img/device_connect/image2.png)

1. Click the Wi-Fi icon, then select the arrow.
You will then see a list of networks. You may need to wait for a minute as Windows populates the list. If the
